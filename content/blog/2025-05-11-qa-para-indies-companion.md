...
slug: "qa-para-indies-companion"
date: 2025-05-11
teaser: /images/posts/qa-para-indies/portada.png
---
...
![logo de Guadalindie, la feria de juegos indie del sur](/images/posts/qa-para-indies/guadalindie-logo.png)

### Slides

Haz click en la imagen que ves a continuación para descargar las slides:

<a href="/downloads/guadalindie/guadalindie.pdf">
![una captura de la portada de la presentación, con título "QA para indies: deja de apagar fuegos y empieza a prevenir bugs"](/images/posts/qa-para-indies/pdf.png)
</a>
...
![Captura del fichero de configuración del CI de Michiball. Separo el fichero en 3 partes: la configuración de cuándo se ejecuta, la sección de variables y la sección de los pasos a seguir](/images/posts/qa-para-indies/config_ci_01.png)
![Captura del fichero de configuración del CI de Michiball. Está enfocada la parte de los pasos a seguir. Los pasos están separados en 4 partes: descarga del repositorio, setup de godot, generar la build web, subirla a itch](/images/posts/qa-para-indies/config_ci_02.png)
...
![imagen de diferencia entre 2 capturas generado por GDSnap](/images/posts/qa-para-indies/player_selection_diff.png)
...
Y si necesitas ayuda configurando esto para tu equipo, [¡ponte en contacto!](/about/)
